...
<body class="g-sidenav-show" style="background-color: #FFF0DC;">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Akun Admin</li>
            </ol>
          </nav>
        </div>
    </nav>
    ...
    <section id="pengaduan-masyarakat" class="container mt-4">
        ...
        <div class="card w-50">
            <div class="card-header text-white" style="background-color: #435585;">Tambah Akun Admin</div>
            <div class="card-body">
