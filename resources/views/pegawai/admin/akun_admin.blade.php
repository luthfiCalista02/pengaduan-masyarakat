          ...
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav d-flex align-items-center  justify-content-end">
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-sm mb-0 me-3 btn-success" href="{{ route('tambah_akun_admin') }}">Tambah Akun</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="shadow-dark border-radius-lg pt-4 pb-3" style="background-color: #435585;">
                  <h6 class="text-white text-capitalize ps-3">Tabel Akun Admin</h6>
                </div>
              </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_akun_admin') }}" class="btn btn-success btn-sm">Edit</a>
