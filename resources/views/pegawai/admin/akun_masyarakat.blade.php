        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Akun Masyarakat</li>
            </ol>
          </nav>
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav d-flex align-items-center  justify-content-end">
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-sm mb-0 me-3 btn-success" href="{{ route('tambah_akun_masyarakat') }}">Tambah Akun</a>
              </li>
            </ul>
          </div>
        </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>John Doe</td>
                                <td>198239812738937</td>
                                <td>
                                    <a href="{{ route('detail_akun_masyarakat') }}" class="btn btn-info btn-sm">Detail</a>
                                    <a href="{{ route('edit_akun_masyarakat') }}" class="btn btn-success btn-sm">Edit</a>
