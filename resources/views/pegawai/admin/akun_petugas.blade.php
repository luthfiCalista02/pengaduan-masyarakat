        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Akun Petugas</li>
            </ol>
          </nav>
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav d-flex align-items-center  justify-content-end">
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-sm mb-0 me-3 btn-success" href="{{ route('tambah_akun_petugas') }}">Tambah Akun</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="shadow-dark border-radius-lg pt-4 pb-3" style="background-color: #435585;">
                  <h6 class="text-white text-capitalize ps-3">Tabel Akun Petugas</h6>
                </div>
              </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_akun_petugas', 1) }}" class="btn btn-success btn-sm">Edit</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_akun_petugas', 2) }}" class="btn btn-success btn-sm">Edit</a>
                                    <form id="delete-form-2" action="{{ route('akun.hapus', 2) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
