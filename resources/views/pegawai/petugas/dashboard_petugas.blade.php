...
<body class="g-sidenav-show" style="background-color: #FFF0DC;">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 my-2" id="sidenav-main" style="background-color: #435585;">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active text-dark" href="{{ route('dashboard_petugas') }}" style="background-color: #FFF0DC;">
            <i class="material-symbols-rounded" style="color: #435585;">dashboard</i>
            <span class="nav-link-text ms-1" style="color: #435585;">Dashboard Petugas</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{ route('petugas_tabel_pengaduan') }}">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard Petugas</li>
          </ol>
        </nav>
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
          <h3 class="mb-0 h4 font-weight-bolder mb-4">Dashboard Petugas</h3>
        </div>
